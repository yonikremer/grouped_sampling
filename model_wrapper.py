...
class ModelWrapper:
    ...
    def __init__(
        ...
        Args:
            ...
            repetition_penalty_strategy: the strategy to be used for the repetition penalty
    ...
    def get_prob_mat(self, tokens: TokenIDS, generation_start: int) -> Tensor:
        ...
        penalized_logits = self.repetition_penalty_strategy(unscaled_relevant_logits, tokens, generation_start)
