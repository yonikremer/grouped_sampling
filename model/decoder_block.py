from keras.layers import Dropout, Layer, LayerNormalization
...
class DecoderBlock(Layer):
    ...
    def __init__(self, d_model: int, num_heads: int, dff: int, rate: float,
                 *args, **kwargs):
    ...
    def call(self, x: Tensor, look_ahead_mask: Tensor, padding_mask: Tensor,
        ...
        attn2 = self.mha(out1, out1, padding_mask)
        # (batch_size, input_seq_len, d_model)
