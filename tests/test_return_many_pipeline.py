...
class TestLogitsToTokensReturnMany:
    ...
    def test_valid_input(self, batch_size, output_length, vocab_size,
        ...
        assert output.shape == (batch_size, num_return_sequences,
                                output_length)
    ...
    def test_top_p_and_top_k():
        ...
        output = pipeline.logits_to_tokens_return_many(logits,
                                                       num_return_sequences)
        assert output.shape == (batch_size, num_return_sequences,
                                output_length)
        assert (output >= 0).all() and (output <= vocab_size - 1).all()
