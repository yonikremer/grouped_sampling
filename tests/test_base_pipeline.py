...
class TestBasePipeLine:
    ...
    def test_instantiation(self):
        ...
        assert pipeline.device == torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')
    ...
    def test_tokens_batch_to_logit_matrices(self):
        ...
        logits, last_non_pad_indices = pipeline.tokens_batch_to_logit_matrices(tokens, 10)
