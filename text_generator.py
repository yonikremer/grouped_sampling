...
def compare_generators(non_grouped_generator: TextGenerator, prompt: str, num_tokens: int, group_size: int):
    ...
    non_grouped_ans: str = non_grouped_generator(prompt_s=prompt, max_new_tokens=num_tokens)[0]["generated_text"]
    ...
    grouped_ans: str = grouped_generator(prompt_s=prompt, max_new_tokens=num_tokens)[0]["generated_text"]
